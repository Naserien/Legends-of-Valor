...
//    public static void color_print(Object obj, String color) {
//        System.out.print(get_message_with_color(obj.toString(), color));
//    }
...
//                return BLACK;
    ...
    public static String select_color(String default_color) {
        Utils.print_instr_line();
        Color.select_color();
        System.out.printf("Please choose your color (or leave empty to use the default color %s).\n",
                get_message_with_color(default_color, default_color));
        Utils.print_instr_line();
        String color;
        while (true) {
            color = InputScanner.input_string();
            if (color.isEmpty()) {
                color = default_color;
                break;
            }
